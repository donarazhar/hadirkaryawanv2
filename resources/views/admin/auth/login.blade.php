...
<head>
    ...
    <meta name="description" content="Login Administrator PresensiGPS YPI Al Azhar.">
    <title>Login Administrator — PresensiGPS</title>
    ...
    <div class="login-wrapper" x-data="{ 
        ...
        <div class="header">
            <div class="logo-container">
                ...
                <div class="logo-text">Administrator <span style="color: var(--primary-color);">Panel</span></div>
            </div>
            <p class="welcome-subtitle">Masuk ke sistem untuk mengelola data presensi dan konfigurasi karyawan.</p>
        </div>
        ...
        <form action="{{ route('panel.login.process') }}" method="POST">
            ...
            <button 
                type="submit" 
                class="btn-submit"
                :class="{'active': email.length > 0 && password.length > 0}"
            >
                Login Admin
            </button>
        </form>
