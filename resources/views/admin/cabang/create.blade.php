...
@section('page-title', 'Tambah Data Cabang')
...
<div class="form-wrap">
    ...
    <div class="form-header">
        <div class="form-header-left">
            ...
            <div>
                <div class="form-header-title">Tambah Cabang</div>
                <div class="form-header-sub">Buat data cabang baru untuk operasional presensi</div>
            </div>
        </div>
        <div>
            <a href="{{ route('panel.cabang.index') }}" class="btn-back">
                    ...
                    <div class="card-body">
                        ...
                        <div class="fg">
                            ...
                            <input type="text" name="kode_cabang" class="form-control @error('kode_cabang') is-invalid @enderror" 
                                placeholder="Contoh: CBG001" value="{{ old('kode_cabang') }}" maxlength="10" required>
                            @error('kode_cabang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-hint"><i class="mdi mdi-information-outline"></i> Maksimal 10 karakter, harus unik.</div>
                        </div>
                        ...
                        <div class="fg">
                            ...
                            <input type="text" name="nama_cabang" class="form-control @error('nama_cabang') is-invalid @enderror" 
                                placeholder="Contoh: YPI Al Azhar Jakarta Pusat" value="{{ old('nama_cabang') }}" maxlength="50" required>
                            @error('nama_cabang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="fg">
                            ...
                            <input type="text" name="lokasi_cabang" class="form-control @error('lokasi_cabang') is-invalid @enderror" 
                                placeholder="Contoh: -6.2088,106.8456" value="{{ old('lokasi_cabang') }}" required>
                            @error('lokasi_cabang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-hint"><i class="mdi mdi-map-marker-radius-outline"></i> Format: <strong>latitude,longitude</strong> (tanpa spasi). Anda dapat menyalin dari Google Maps.</div>
                        </div>
                        ...
                        <div class="fg">
                            ...
                            <input type="number" name="radius_cabang" class="form-control @error('radius_cabang') is-invalid @enderror" 
                                placeholder="Contoh: 100" value="{{ old('radius_cabang') }}" min="1" required>
                            @error('radius_cabang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn-save">
                                <i class="mdi mdi-content-save-check"></i> Simpan Data Cabang
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <ul class="info-list">
                        <li class="info-item">
                            ...
                            <div class="ii-text"><strong>Kode Cabang</strong> akan digunakan sebagai referensi sistem dan harus unik (tidak boleh sama dengan cabang lain).</div>
                        </li>
                        <li class="info-item">
                            <div class="ii-icon"><i class="mdi mdi-map-marker-check"></i></div>
                            <div class="ii-text"><strong>Lokasi</strong> menentukan titik nol (pusat) absensi. Pastikan koordinat diambil dengan akurat.</div>
                        </li>
                        <li class="info-item">
                            <div class="ii-icon"><i class="mdi mdi-radar"></i></div>
                            <div class="ii-text"><strong>Radius</strong> adalah toleransi jarak (dalam meter). Jika diisi 100, karyawan hanya bisa absen dalam radius 100m dari lokasi pusat.</div>
                        </li>
                    </ul>
                </div>
            </div>
