...
<div class="form-wrap">
    ...
    <div class="form-header">
        <div class="form-header-left">
            ...
            <div>
                <div class="form-header-title">Edit Data Cabang</div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="fg">
                            ...
                            <div class="form-hint"><i class="mdi mdi-lock-outline"></i> Kode cabang tidak dapat diubah setelah dibuat.</div>
                        </div>
                        ...
                        <div class="fg">
                            ...
                            <input type="text" name="nama_cabang" class="form-control @error('nama_cabang') is-invalid @enderror" 
                                value="{{ old('nama_cabang', $cabang->nama_cabang) }}" maxlength="50" required>
                            @error('nama_cabang')
                        ...
                        <div class="fg">
                            ...
                            <input type="text" name="lokasi_cabang" class="form-control @error('lokasi_cabang') is-invalid @enderror" 
                                value="{{ old('lokasi_cabang', $cabang->lokasi_cabang) }}" required>
                            @error('lokasi_cabang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="fg">
                            ...
                            <input type="number" name="radius_cabang" class="form-control @error('radius_cabang') is-invalid @enderror" 
                                value="{{ old('radius_cabang', $cabang->radius_cabang) }}" min="1" required>
                            @error('radius_cabang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="card-body">
                    <ul class="info-list">
                        <li class="info-item">
                            ...
                            <div class="ii-text"><strong>Kode Cabang</strong> terkunci untuk menjaga konsistensi relasi data absensi dan pendaftaran wajah.</div>
                        </li>
                        <li class="info-item">
