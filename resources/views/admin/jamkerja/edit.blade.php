                    ...
                    <div class="card-body">
                        <div class="time-grid">
                            <div class="fg">
                                ...
                                <input type="time" name="awal_jam_masuk" class="form-control time-picker-wib" value="{{ old('awal_jam_masuk', date('H:i', strtotime($jamkerja->awal_jam_masuk))) }}">
                            </div>
                            <div class="fg">
                                <label>Jam Masuk (WIB)</label>
                                <input type="time" name="jam_masuk" class="form-control time-picker-wib" value="{{ old('jam_masuk', date('H:i', strtotime($jamkerja->jam_masuk))) }}">
                            </div>
                            <div class="fg">
                                <label>Akhir Jam Masuk (WIB)</label>
                                <input type="time" name="akhir_jam_masuk" class="form-control time-picker-wib" value="{{ old('akhir_jam_masuk', date('H:i', strtotime($jamkerja->akhir_jam_masuk))) }}">
                            </div>
                            <div class="fg">
                                <label>Jam Pulang (WIB)</label>
                                <input type="time" name="jam_pulang" class="form-control time-picker-wib" value="{{ old('jam_pulang', date('H:i', strtotime($jamkerja->jam_pulang))) }}">
                            </div>
                        </div>
                    </div>
                </div>
