    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <a href="#" class="btn btn-success me-2" data-bs-toggle="modal" data-bs-target="#modal-import">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <div class="form-hint mt-2">
                            ...
                            <br>
                            <a href="{{ route('panel.karyawan.downloadTemplate') }}" class="text-primary font-weight-bold">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="search" class="form-control"
                                placeholder="NIK, Nama, atau Jabatan..."
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="kode_cabang" class="form-select">
                                ...
                                <option value="{{ $cbg->kode_cabang }}"
                                    {{ request('kode_cabang') == $cbg->kode_cabang ? 'selected' : '' }}>
                                    {{ $cbg->nama_cabang }}
                                </option>
                                @endforeach
                            </select>
        ...
        <div class="card mt-3">
                ...
                <div class="table-responsive">
                    <table class="table table-vcenter card-table table-striped">
                        <thead>
                            <tr>
                                <th width="50">No</th>
                                <th width="280">Karyawan</th>
                                <th width="200">Info Penempatan</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        @else
                                        <span class="avatar me-2 bg-primary text-white d-flex align-items-center justify-content-center"
                                ...
                                <td>
                                    <div>
                                        ...
                                        @if($item->departemen)
                                        <small class="text-muted d-block">{{ $item->departemen->nama_dept }}</small>
                                        @else
                                ...
                                <td>
                                    @if($item->no_hp)
                                    <div class="d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-phone me-1" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('panel.karyawan.edit', $item->nik) }}"
                            ...
                            <tr>
                                <td colspan="5" class="text-center text-muted py-5">
                                    ...
                                    <div class="fw-bold">Tidak ada data karyawan</div>
                                    <small class="text-muted">Silakan tambah karyawan baru atau ubah filter pencarian</small>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="card-footer d-flex align-items-center">
                <p class="m-0 text-muted">
                    Menampilkan
                    <span class="fw-bold">{{ $karyawan->firstItem() ?? 0 }}</span>
                    sampai
                    <span class="fw-bold">{{ $karyawan->lastItem() ?? 0 }}</span>
                    dari
                ...
                <ul class="pagination m-0 ms-auto">
                    ...
                    @else
                    <li class="page-item">
                        <a class="page-link" href="{{ $karyawan->previousPageUrl() }}" rel="prev">‹ Previous</a>
                    </li>
                    @endif
                    ...
                    <li class="page-item">
                        <a class="page-link" href="{{ $karyawan->nextPageUrl() }}" rel="next">Next ›</a>
                    </li>
                    @else
                    <li class="page-item disabled">
