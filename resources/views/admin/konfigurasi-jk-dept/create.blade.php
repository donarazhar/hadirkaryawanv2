    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Form Tambah Konfigurasi Jam Kerja Departemen</h5>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ route('panel.konfigurasi-jk-dept.store') }}" method="POST" id="formKonfigurasi">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="kode_jk_dept" class="form-label">Kode Konfigurasi <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('kode_jk_dept') is-invalid @enderror"
                                    id="kode_jk_dept" name="kode_jk_dept"
                                    placeholder="Contoh: JKDEPT001"
                                    value="{{ old('kode_jk_dept') }}"
