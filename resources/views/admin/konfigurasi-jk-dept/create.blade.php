...
@section('title', 'Tambah Konfigurasi Jam Kerja Departemen')
@section('page-title', 'Tambah Konfigurasi Jam Kerja Departemen')
...
<style>
    ...
    .form-header-icon i { font-size: 22px; color: var(--indigo); }
    ...
    .card-head i { font-size: 18px; color: var(--indigo); }
    ...
    .btn-add-day {
        ...
        font-size: 12.5px; font-weight: 700; color: var(--white); background: var(--indigo);
        cursor: pointer; display: inline-flex; align-items: center; gap: 6px; transition: background 0.15s;
    }
    ...
    .row-number { font-weight: 800; color: var(--indigo); background: var(--indigo-soft); width: 28px; height: 28px; display: inline-flex; align-items: center; justify-content: center; border-radius: 8px; font-size: 12px; }
...
<div class="form-wrap">
    ...
    <div class="form-header">
        <div class="form-header-left">
            ...
            <div>
                <div class="form-header-title">Tambah Konfigurasi</div>
                <div class="form-header-sub">Atur jadwal hari dan jam kerja untuk departemen</div>
            </div>
        </div>
        <div>
            <a href="{{ route('panel.konfigurasi-jk-dept.index') }}" class="btn-back">
    ...
    <div class="form-grid">
        ...
        {{-- LEFT COLUMN: FORM --}}
        <div>
            <form action="{{ route('panel.konfigurasi-jk-dept.store') }}" method="POST" id="formKonfigurasi">
                @csrf
                    ...
                    <div class="card-body" style="padding-bottom:4px;">
                        <div class="fg-row">
                            <div class="fg">
                                ...
                                <input type="text" name="kode_jk_dept" class="form-control @error('kode_jk_dept') is-invalid @enderror" 
                                    placeholder="Contoh: JKDEPT001" value="{{ old('kode_jk_dept') }}" maxlength="10" required>
                                @error('kode_jk_dept')
                            ...
                            <div class="fg">
                                ...
                                <select name="kode_cabang" class="form-select @error('kode_cabang') is-invalid @enderror" required>
                ...
                <div class="card" style="background:transparent; border:none; box-shadow:none;">
                    <div class="form-actions" style="margin-top:0; border-top:none; padding-top:0;">
                        <button type="submit" class="btn-save">
                            <i class="mdi mdi-content-save-check"></i> Simpan Konfigurasi
                        </button>
                    </div>
                </div>
