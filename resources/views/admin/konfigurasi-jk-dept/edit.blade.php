                    ...
                    <div class="card-body" style="padding-bottom:4px;">
                        <div class="fg-row">
                            <div class="fg">
                                ...
                                <input type="text" class="form-control" value="{{ $konfigurasi->kode_jk_dept }}" disabled>
                            ...
                            <div class="fg">
                                ...
                                <select name="kode_cabang" class="form-select @error('kode_cabang') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $cbg->kode_cabang }}" {{ old('kode_cabang', $konfigurasi->kode_cabang) == $cbg->kode_cabang ? 'selected' : '' }}>
                                        {{ $cbg->nama_cabang }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="fg">
                                ...
                                <select name="kode_dept" class="form-select @error('kode_dept') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $dept->kode_dept }}" {{ old('kode_dept', $konfigurasi->kode_dept) == $dept->kode_dept ? 'selected' : '' }}>
                                        {{ $dept->nama_dept }}
                                    </option>
                                    @endforeach
                                </select>
