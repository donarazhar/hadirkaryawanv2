...
<div class="form-wrap">
    ...
    <div class="form-grid">
        ...
        {{-- LEFT COLUMN: FORM --}}
        <div>
            <form action="{{ route('panel.konfigurasi-jk-unit.store') }}" method="POST" id="formKonfigurasi">
                @csrf
                        ...
                        <div class="fg-row">
                            ...
                            <div class="fg">
                                ...
                                <select name="branch_id" class="form-select @error('branch_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $cbg->id }}" {{ old('branch_id') == $cbg->id ? 'selected' : '' }}>
                                        {{ $cbg->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="fg">
                                ...
                                <select name="unit_id" class="form-select @error('unit_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $dept->id }}" {{ old('unit_id') == $dept->id ? 'selected' : '' }}>
                                        {{ $dept->name }}
                                    </option>
                                    @endforeach
                                </select>
