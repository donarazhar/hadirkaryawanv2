...
<div class="config-wrap">
    ...
    <div class="config-header">
        ...
        <div class="config-header-actions">
            <a href="{{ route('panel.konfigurasi-jk-unit.create') }}" class="btn-hdr btn-hdr-primary">
    ...
    <div class="filter-card">
        ...
        <div class="filter-body">
            <form action="{{ route('panel.konfigurasi-jk-unit.index') }}" method="GET">
                <div class="filter-grid">
                    ...
                    <div class="fg">
                        ...
                        <select name="branch_id">
                            ...
                            <option value="{{ $cbg->id }}" {{ request('branch_id') == $cbg->id ? 'selected' : '' }}>
                                {{ $cbg->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        <a href="{{ route('panel.konfigurasi-jk-unit.index') }}" class="btn-reset">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width:250px;">Organisasi (Cabang & Unit)</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="code-pill">{{ $config->kode_jk_unit }}</div>
                        </td>
                        <td>
                            <div class="org-info">
                                <div class="org-item">
                                    <i class="mdi mdi-office-building icon-cabang"></i>
                                    {{ $config->branch->name ?? 'N/A' }}
                                </div>
                                <div class="org-item">
                                    <i class="mdi mdi-sitemap icon-dept"></i>
                                    {{ $config->unit->name ?? 'N/A' }}
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="action-cell">
                                <a href="{{ route('panel.konfigurasi-jk-unit.show', $config->kode_jk_unit) }}" class="btn-act btn-act-blue" title="Detail">
                                    <i class="mdi mdi-eye"></i>
                                </a>
                                <a href="{{ route('panel.konfigurasi-jk-unit.edit', $config->kode_jk_unit) }}" class="btn-act btn-act-yellow" title="Edit">
                                    <i class="mdi mdi-pencil"></i>
                                </a>
                                <button type="button" class="btn-act btn-act-red" onclick="confirmDelete('{{ $config->kode_jk_unit }}')" title="Hapus">
    ...
    function confirmDelete(kode) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = '{{ url("panel/konfigurasi-jk-unit") }}/' + kode;
                form.submit();
            }
        });
    }
