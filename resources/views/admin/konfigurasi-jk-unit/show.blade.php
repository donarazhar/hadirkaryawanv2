...
<div class="detail-wrap">
    ...
    <div class="detail-header">
        ...
        <div class="header-actions">
            <a href="{{ route('panel.konfigurasi-jk-unit.index') }}" class="btn-hdr">
                <i class="mdi mdi-arrow-left"></i> Kembali
            </a>
            <a href="{{ route('panel.konfigurasi-jk-unit.edit', $konfigurasi->kode_jk_unit) }}" class="btn-hdr btn-edit">
    ...
    <div class="meta-grid">
        <div class="meta-card">
            ...
            <div class="meta-value"><span class="code-pill">{{ $konfigurasi->kode_jk_unit }}</span></div>
        </div>
        <div class="meta-card">
