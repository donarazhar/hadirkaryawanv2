            ...
            <td>
                @if ($d->jam_in)
                    <div class="d-flex align-items-center">
                        ...
                        @else
                            <img src="{{ $foto_in ?: asset('assets/img/sample/avatar/noprofile.png') }}" class="foto-thumb me-2" alt="Foto Masuk">
                        @endif
                        <div>
            ...
            <td>
                @if ($d->jam_out)
                    <div class="d-flex align-items-center">
                        ...
                        @else
                            <img src="{{ $foto_out ?: asset('assets/img/sample/avatar/noprofile.png') }}" class="foto-thumb me-2" alt="Foto Pulang">
                        @endif
                        <div>
